...
app.get("/", (request, response) => {
    console.log(`Ping hazır Fearless Register aktif.`);
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'link') {
    msg.reply('Linkimiz:https://discord.gg/DTUbuyw');
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'tag') {
    msg.reply('Hoş Geldin Tagımız:❤ | FeArLeSs');
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'sa') {
    msg.reply('Aleyküm Selam,  Hoş Geldin , Nasılsın İyimisin , Bügün İyi Eğlenceler ^^');
  }
});
