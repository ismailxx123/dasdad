...
let   ERKEKROLİSİM = "❤️ | FeArLeSs Bayan Üye"
let   ALANACAKROLİSİM = "❤️ | FeArLeSs Kayıtsızlar"
...
exports.run = async (client, message, args) => {
  ...
  if(!kullanici) return message.reply(`:warning: Lütfen bir kullanıcı giriniz! \nDoğru Kullanım; \`${prefix}bayan @${client.user.username}#${client.user.discriminator} <yeni isim>\``)
