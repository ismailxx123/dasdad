...
const radyo = {
    fenomen : "https://canliradyodinle.gen.tr/kralpop.htm ",
...
exports.run = function(bot, message, args) {
  ...
  message.delete(10000).catch(console.error);
    if (!message.member.voiceChannel) return message.reply("**:bangbang: Sana bağlanmam için ilk önce sesli bir kanala katılmalısın. :bangbang:** ❤ | FeArLeSs | ❤ | Guard | ❤").then(m => m.delete(15000)).catch(console.error);
    else {
